    ...
    <body style="font-family: 'Roboto Mono">
        ...
        <form action="/diaries" method="POST" enctype="multipart/form-data">
            ...
            <div class="title">
                ...
                <input type="text" name="diary[title]" placeholder="タイトルを入力" value="{{ old('diary.title') }}"/>
                <p class="title_error" style="color:red">{{ $errors->first('diary.title') }}</p>
            </div>
            <div class="body">
                <p>Body.</p>
                <textarea name="diary[body]" placeholder="本文を入力">{{ old('diary.body') }}</textarea>
            ...
            <div>
                ...
                <div class="tags items-center flex flex-wrap">
                    @foreach($tags as $tag)
                        <div class="py-2">
                            <label for="tag-{{ $tag->id }}" class="text-sm rounded-full my-2 mx-2 px-2 py-1 text-center border border-transparent has-[:checked]:border-black">
                    ...
                    @if (old('new_tag_names'))
                        @foreach (old('new_tag_names') as $tagName)
                            <label for="new-tag-{{ $tagName }}" class="text-sm rounded-full my-2 mx-2 px-2 py-1 text-center border border-transparent has-[:checked]:border-black">
                    ...
                    <div class="flex items-center" id="add-new-tag">
                        <button type="button" class="rounded-full my-2 mx-2 px-2 py-1 text-center">＋</button>
            ...
            <div id="crop-modal" class="hidden fixed inset-0 bg-black bg-opacity-75 flex justify-center items-center">
                <div class="bg-white p-4">
                    ...
                    <div class="modal-footer flex justify-end mt-4">
                        <button id="crop-button" class="px-4 py-2 bg-blue-500 text-white">crop</button>
                        <button id="cancel-button" class="px-4 py-2 bg-gray-500 text-white ml-2">cancel</button>
                    </div>
                </div>
            </div>
